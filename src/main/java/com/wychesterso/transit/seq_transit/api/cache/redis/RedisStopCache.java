package com.wychesterso.transit.seq_transit.api.cache.redis;

import com.wychesterso.transit.seq_transit.api.cache.StopCache;
import com.wychesterso.transit.seq_transit.api.cache.dto.BriefStopResponseList;
...
public class RedisStopCache implements StopCache {

    private static final Duration TTL = Duration.ofHours(24);

    private final RedisTemplate<String, Object> redis;

    public RedisStopCache(RedisTemplate<String, Object> redis) {
        this.redis = redis;
    }
